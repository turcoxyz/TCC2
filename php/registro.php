...
if (isset($_POST['submit'])) {
    ...
    if ($password !== $confirm_password) {
        ...
        // Prepara a consulta
        $stmt = $conexao->prepare("INSERT INTO usuarios (nm_complete, nm_user, email, telefone, senha, sexo, dt_nascimento, nm_bairro, endereço) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssssss", $nome, $nomeUser, $email, $telefone, $password, $sexo, $dt_nascimento, $nm_bairro, $endereço);
